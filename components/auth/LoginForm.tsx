  ...
  return (
    <div className="flex min-h-screen w-full flex-col items-center justify-center bg-[#fffefb] p-4 sm:p-8">
      <div className="mb-8 flex flex-col items-center text-center">
        ...
        <h1 className="text-[32px] font-bold tracking-tight text-[#201515] uppercase">
          Asih Plastik
        </h1>
      ...
      <div className="w-full max-w-[440px] rounded-[5px] border border-[#c5c0b1] bg-[#fffefb] p-6 shadow-none sm:p-10">
        ...
        <form onSubmit={handleSubmit} className="space-y-6">
          ...
          <button
            type="submit"
            disabled={isLoading}
            className="flex w-full items-center justify-center rounded-[4px] border border-[#ff4f00] bg-[#ff4f00] px-[24px] py-[16px] text-[16px] font-semibold text-[#fffefb] transition-colors hover:border-[#e04500] hover:bg-[#e04500] disabled:cursor-not-allowed disabled:opacity-70"
          >
            {isLoading ? (
              <>
